...
echo "<h3>2. Define a variable whose value is the result of the function that 
returns a rounded value to the next highest integer.</h3>";
$round = ceil(2.8);
echo " \$round = ceil(2.8);<br>";
echo var_dump($round);

echo "<h3>3. Define a variable whose value is the result of the function that 
...
echo "<h3>4. Define a variable whose value is the result of the function that 
...
echo "<h3>5. Define a variable whose value is the result of the function that 
