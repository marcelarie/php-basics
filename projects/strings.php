...
echo "<h3>2. Print a text string that interpret variables</h3>";
$textString = 'Yep';
echo "\$textString = 'Yep';<br>
echo \$textString; =>".$textString;

echo "<h3>3. Concatenate a previously declared variable in a text string</h3>";
echo "\$text = 'CAT';<br>
\$otherText = 'DOG';<br>
...
echo "<h3>4. Execute the function that allows you to replace text in a string (case
 sensitive)</h3>";
...
echo "<h3>5. Execute the function that allows you to replace text in a string 
...
echo "<h3>6. Execute the function that allows you to write a text N times</h3>";
...
echo "<h3>7. Execute the function that allows to obtain the length of a text string
</h3>";
...
echo "<h3>8. Executes the function that allows to obtain the position of the first 
...
echo "<h3>9. Execute the function that allows a text string to be capitalized</h3>";
echo "echo strtoupper('roger rabbit'); => ";
echo strtoupper('roger rabbit');

echo "<h3>10. Execute the function that allows you to transform a text string to 
lowercase</h3>";
echo "echo strtolower('ROGER RABBIT'); => ";
echo strtolower('ROGER RABBIT');

echo "<h3>11. Execute the function that allows to obtain a text substring from the 
position</h3>";
